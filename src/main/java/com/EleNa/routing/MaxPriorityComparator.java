...
//Use this Comparator if you want the PriorityQueue to return items with the highest priority
public class MaxPriorityComparator implements Comparator<PriorityQueueItem> {
